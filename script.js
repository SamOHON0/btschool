...
if(chatBtn){
  var KB=[
    {keys:['price','cost','how much','rate','pricing','fee','euro'],reply:'A one hour driving lesson is 60 euro, and a 12 hour EDT package is 660 euro. Pre-tests are 60 euro (1hr) or 120 euro (2hr). Jeep and trailer lessons are 140 euro, truck lessons 170 euro. Call 087 127 8147 or 087 703 9072 to book.'},
    ...
    {keys:['truck','hgv','rigid','career'],reply:'Truck lessons and assessments are 170 euro for two hour slots. Truck driving assessments are 150 euro (1.5hrs with a written report). We also do company driver assessments and contracts. Call 087 127 8147 or 087 703 9072.'},
    ...
    {keys:['nervous','anxious','automatic','refresher','night'],reply:'Yes, we cover nervous driver, refresher and night driving courses, plus manual and automatic tuition. Patient, encouraging instruction built around you. Call 087 127 8147 or 087 703 9072.'},
